    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0  pointer-events-none">
                {/* FILL — INSIDE BORDER */}
                <div className={`absolute  top-1.25 bottom-1.25 left-1.25 right-2.25 group-hover:opacity-100 opacity-0 transition-all duration-150 ${color === 'black' ? 'bg-black' : 'bg-foreground'} `} />
            ...
            <div className="relative z-10 flex h-full items-center gap-x-2 justify-center  group">
                ...
                <div className='mt-1'>
                    <ArrowRight className={`${color === 'white' ? 'group-hover:stroke-black stroke-foreground' : 'stroke-black group-hover:stroke-foreground'}  duration-150 transition-all text-2xl`} />
                </div>
            </div>
        </div>
