...
const PickUp = () => {
    ...
    return (
        <div ref={contaierRef} className='min-h-screen px-2 flex w-full flex-col md:flex-row'>
            <div className='leftSide md:w-[50%] w-full py-[10%] md:h-screen flex items-center justify-center'>
            ...
            <div className="rightSide text-background flex flex-col gap-y-12.5 font-outfit text-2xl w-full md:w-[50%]">
                <div className="md:h-screen w-full card1">
                    <ImgCard
                ...
                <div className="md:h-screen w-full card2">
                    <ImgCard
                ...
                <div className="md:h-screen w-full card3">
                    <ImgCard
                ...
                <div className="md:h-screen w-full card4">
                    <ImgCard
                ...
                <div className="md:h-screen w-full card5">
                    <ImgCard
