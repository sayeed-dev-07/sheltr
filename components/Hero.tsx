...
const Hero = ({ introCom }: { introCom: boolean }) => {
    ...
    return (
        <div ref={containerRef} className='heroSection lg:h-[90vh] after:content-[""] after:w-full after:h-full after:absolute after:inset-0 after:z-10 after:bg-black/40  border-b-2 border-background md:h-[75vh]  h-[50vh] sm:h-[60vh] flex  w-full bg-[skyblue] relative'>
            {
