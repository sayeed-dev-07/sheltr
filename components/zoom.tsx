...
const Zoom = () => {
  ...
  return (
    <div ref={mainContainerRef} className='w-full  bg-[#507737] h-screen flex items-end justify-center mt-[45%] md:mt-0'>
      ...
      <div ref={imgContainerRef} className='relative after:content-[""] after:w-full after:h-full after:absolute after:inset-0 after:z-3 after:bg-black/30 overflow-hidden'>
